  ...
  return (
    <>
            <div id="container-form" className="bg-white p-8 rounded-lg shadow-md w-5/6  max-w-4xl form">
                <form id="materiaPrimaForm" className="grid md:grid-cols-3 gap-10" onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col">
                        ...
                        <input type="submit" value="Guardar" className="mt-auto bg-violet-700 text-white p-2 rounded hover:bg-violet-900 cursor-pointer mt-2" required/>
                    </div>
